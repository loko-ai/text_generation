...
model = Arg(name="model", label="Transforme Models", type="text", helper='Default model "gpt2". Type the name of the huggingface model you want to use, selecting among the ones available for the text-generation task (check the list here: https://huggingface.co/models?pipeline_tag=text-generation)', value="gpt2")
...
text_gen_component = Component(name="TextGenerator", inputs=input_list, outputs=output_list, args=args, description=text_gen_description, icon="RiFileList3Fill")
